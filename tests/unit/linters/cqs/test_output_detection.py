...
Overview: TDD test suite for OUTPUT operation detection. Tests identification of
    ...
    All tests are marked with skip pending implementation.
...
class TestStatementCall:
    ...
    def test_detects_statement_call(self) -> None:
        ...
        # outputs = detector.find_outputs(parse(code))
