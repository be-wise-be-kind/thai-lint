...
Overview: Test suite for the main LBYLRule class that implements BaseLintRule.
...
Implementation: Tests for LBYLRule property and check behavior
"""

from src.linters.lbyl import LBYLRule
